...
function postnew() {
    ...
    $.ajax({
    	// run locally (first)
        //url : "http://localhost:7071/api/loriwritecosmos",
        
        // run locally (second)
        //url : "http://localhost:7071/api/loriMongoWriter",
...
function createList(which, city) {
    ...
    $.get("https://loricosmosdatawriter.azurewebsites.net/api/loriwritecosmos/?name="+ param, function(data, status){
